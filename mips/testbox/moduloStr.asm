...
modulo_str:
	# TODO
        ...
        li $t2, 10       	 #my implementation start for the horner's logic
        mulu $t5 $0 $t2
loop:   
    	lb $t0, ($a0)        #load the first byte from the buffer
   	subu $t4, $t0, 48    #convert from ASCII to int
	...
	move $v0 $t5
    	#div $t0, $a2	#after getting the original number in $t0 by Horner's, I divide by the divisor !
    	#mfhi $v0
    	#remu $v0, $t0, $a2 #or this one as described on forum ! 
